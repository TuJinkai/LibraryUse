...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="header">
            <h1 class="page-header">分页面数据管理</h1>
            <ol class="breadcrumb">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="widthmax col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                    	<!-- 新书热搜  -->
                        <div class="card-action">新书热搜：</div>
                        <div class="card-content">
                        
                        	<div class="Bookcharts chartTOU1">新书速递：</div>
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">删除</a>
								</div>
								<div class="BookName">JAVA从入门到放弃
								</div>
                        	</div>
                        	<!-- 
                        	<div class="Bookchart">
                        	...
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">+</a>
								</div>
								<div class="BookName">null
								</div>
                        	</div>
                        	
                        	<br><br>
                        	
                        	<div class="Bookcharts chartTOU1">热搜图书：</div>
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">删除</a>
								</div>
                        ...
                        <!-- 名人名著  -->
                        <div class="card-action">名人名著：</div>
                        <div class="card-content">
                        
                        	<div class="Bookcharts chartTOU2">名家新作：</div>
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">删除</a>
								</div>
                        	...
                        	<div class="Bookcharts chartTOU2">名著热读：</div>
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">删除</a>
								</div>
                        ...
                        <!-- 学习资料  -->
                        <div class="card-action">学习资料：</div>
                        <div class="card-content">
                        
                        	<div class="Bookcharts chartTOU3">新进资料：</div>
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">删除</a>
								</div>
                        	...
                        	<div class="Bookcharts chartTOU3">资料热搜：</div>
                        	<div class="Bookchart">
								<div class="delete" align="center">
									<a href="" style="color:#444444;" onmouseover="this.style.color='#a0a0a0'" onmouseout="this.style.color='#444444'">删除</a>
								</div>
