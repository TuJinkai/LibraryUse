...
<div style="margin-top:100px">
    <div style="font-weight: bold;font-size: 18px;" align="center">
        ...
        <p>非常抱歉<span style="color: #dd4d40;font-size: 20px;">您的操作</span>失败了</p>
    </div>
    <div align="center">
        <a href="BookInfo.jsp?book_id=<%=request.getAttribute("Book_Id").toString()%>"><button class="btn btn-lg btn-info bt2" type="submit">返回图书页面</button></a>
    </div>
</div>
