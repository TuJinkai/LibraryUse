        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="widthmax col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="card-action">搜索用户：</div>
                        <form class="card-content" action="Change_UserInfo_Admin.jsp" method="post" accept-charset="UTF-8">
                            <input name="" class="form-control"  placeholder="请输入用户邮箱" required />
                            <div align="right">
